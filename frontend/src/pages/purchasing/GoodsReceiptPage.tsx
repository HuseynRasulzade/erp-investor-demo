...
function useGoodsReceiptKind(): DocKind {
  ...
  return {
    ...
    showPrice: true,
    showTax: false,
    priceViewPerm: 'purchase_execution.price_view',
    showOverReceiptReason: true,
    approvePerm: 'purchase_execution.receipt.approve',
    rejectPerm: 'purchase_execution.receipt.reject',
